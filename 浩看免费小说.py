...
new Env("浩看免费小说")
app 浩看免费小说
export hkreadcks='整条url#提现目标' # 抓https://welfare-dj.palmestore.com 整条url 请注意url参数p16=xxxx 如果带有空格请手动去除空格 空格转码后为%20 也请去除
export hkreadcks='整条url#15'
并发格式 hk_multi='true'
cron: 8 7,9-21 * * *
不恰了，也不对外开放，请勿使用
听书，看小说，提现，刷视频任务都差不多有了
